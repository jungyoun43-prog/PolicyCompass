...
import { DEFAULT_CLAIM_RULES, evaluateClaimRule, normalizeClaimRule } from "./claim-rules.js";
...
const cleanText = textCleaner({ fallbackSecond: true, maxLength: 2_000 });
...
export function validTimestamp(value, fallback = new Date().toISOString()) {
...
export function audit(action, now, { patientId = "", encounterId = "", entityId = "", detail = "" } = {}) {
  return {
    id: uniqueId("audit"),
