...
const QUESTION_RULES = {
  ...
  copd: [
    ...
    },
    {
      ...
      reason: "내 상태에 맞는 활동 종류와 쉬는 기준을 구체적으로 확인하기 위해서입니다.",
    },
    {
  ...
  pneumonia: [
    {
      question: "퇴원 뒤에는 어떤 음식을 먹고, 수분은 어느 정도 마시면 좋을까요?",
      reason: "식욕과 호흡 상태에 맞는 회복기 식사 방법을 구체적으로 확인하기 위해서입니다.",
    },
    {
      question: "걷기 같은 운동은 언제부터, 한 번에 몇 분씩 다시 시작하면 좋을까요?",
      reason: "숨참과 피로를 살피면서 활동을 안전하게 늘리는 기준을 확인하기 위해서입니다.",
    },
    {
      question: "열·기침·가래나 숨참이 어느 정도 심해지면 다시 병원에 연락해야 할까요?",
      reason: "회복 중 지켜볼 변화와 빨리 도움받아야 할 신호를 구분하기 위해서입니다.",
    },
  ],
  migraine: [
    {
