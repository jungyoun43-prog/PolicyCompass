...
export const MEDICATION_CATALOG = Object.freeze([
  ...
  medication({
    ...
    coverage: {
      ...
      requiredEvidence: [{ code: "85354-9", system: LOINC_SYSTEM, label: "최근 180일 이내 혈압 측정 기록", eventTypes: ["observation"], lookbackDays: 180, severity: "required" }],
      duplicateClass: "RAS",
      duplicateClassLabel: "레닌-안지오텐신계 억제제(ACEI·ARB)",
      maxDurationDays: 90,
      ageMinimum: 18,
    },
  }),
  ...
  medication({
    ...
    ingredient: "하이드로클로로티아지드",
    classLabel: "티아지드계 이뇨제",
  ...
  medication({
    ...
    coverage: {
      ...
      duplicateClassLabel: "SGLT-2 억제제",
      maxDurationDays: 90,
      ageMinimum: 18,
    },
  }),
  ...
  medication({
    ...
    ingredient: "티오트로피움브롬화물",
    classLabel: "지속성 무스카린길항제(LAMA)",
    ...
    coverage: {
      ...
      duplicateClass: "LAMA",
      duplicateClassLabel: "지속성 무스카린길항제(LAMA)",
      maxDurationDays: 90,
      ageMinimum: 18,
    },
  }),
  medication({
    ...
    ingredient: "살메테롤시나포산염·플루티카손프로피온산염",
    classLabel: "LABA/ICS 복합 흡입제",
    ...
    coverage: {
      ...
      duplicateClassLabel: "LABA/ICS 복합 흡입제",
      maxDurationDays: 90,
      ageMinimum: 12,
    },
  }),
  medication({
    ...
    ingredient: "아목시실린수화물·클라불란산칼륨",
    classLabel: "페니실린계 항생제",
  ...
  medication({
    ...
    ingredient: "판토프라졸나트륨수화물",
    classLabel: "프로톤펌프억제제(PPI)",
    ...
    coverage: {
      ...
      requiredEvidence: [],
      duplicateClass: "PPI",
      duplicateClassLabel: "프로톤펌프억제제(PPI)",
      maxDurationDays: 56,
      ageMinimum: 18,
    },
  }),
  ...
  medication({
    ...
    coverage: {
      ...
      duplicateClassLabel: "비스테로이드소염진통제(NSAID)",
      maxDurationDays: 30,
      ageMinimum: 12,
    },
  }),
...
export const CHART_MEDICATION_CLASS_HINTS = Object.freeze([
  Object.freeze({ class: "RAS", classLabel: "레닌-안지오텐신계 억제제(ACEI·ARB)", codes: ["MED-ARB", "C09AA03", "C09CA01"], keywords: ["arb", "acei", "안지오텐신", "리시노프릴", "로사르탄", "혈압약"] }),
  Object.freeze({ class: "LAMA", classLabel: "지속성 무스카린길항제(LAMA)", codes: ["DEMO-LAMA"], keywords: ["lama", "티오트로피움", "흡입제"] }),
  Object.freeze({ class: "PPI", classLabel: "프로톤펌프억제제(PPI)", codes: ["MED-PPI"], keywords: ["ppi", "위산", "판토프라졸", "오메프라졸"] }),
  Object.freeze({ class: "TRIPTAN", classLabel: "트립탄계 편두통 치료제", codes: ["MED-TRIPTAN"], keywords: ["triptan", "트립탄", "편두통"] }),
  Object.freeze({ class: "CCB", classLabel: "칼슘차단제(CCB)", codes: [], keywords: ["암로디핀", "amlodipine", "ccb"] }),
  Object.freeze({ class: "STATIN", classLabel: "스타틴", codes: [], keywords: ["스타틴", "statin", "아토르바스타틴"] }),
  Object.freeze({ class: "BIGUANIDE", classLabel: "비구아나이드", codes: [], keywords: ["메트포르민", "metformin"] }),
]);
